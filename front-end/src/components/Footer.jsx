  ...
  return (
    <footer>
      <div className="container">
        ...
        <div className="brand">
          <h1>GoBooking</h1>
          <h3>Đem đến trải nghiệm tuyệt vời nhất cho bạn!</h3>
        </div>
        ...
        <div className="contact-info">
          ...
          <div className="social-icons">
            ...
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                <path fill="#FF0000" d="M24 4.5C13.2 4.5 4.5 13.2 4.5 24S13.2 43.5 24 43.5 43.5 34.8 43.5 24 34.8 4.5 24 4.5z"></path>
              </svg>
            </a>
          </div>
        </div>
