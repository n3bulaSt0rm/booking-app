...
export default function Footer() {
    return (
        <footer className="bg-gray-800 text-white py-10 px-14">
            <div className="container mx-auto flex justify-between items-center">
                <div className="flex flex-col items-center flex-grow">
                    <h1 className="text-3xl font-bold text-yellow-400">GoBooking</h1>
                    <h3 className="text-gray-400 mt-2 text-center">
                        Đem đến trải nghiệm tuyệt vời nhất cho bạn!
                    </h3>
                </div>
                <div className="text-right">
                    <h2 className="text-lg font-semibold">Thông tin liên hệ</h2>
                    <p className="text-gray-400">Nhóm 15</p>
                    <p className="text-gray-400">Công nghệ Web và Dịch vụ trực tuyến</p>
                    <p className="text-gray-500 mt-4">
                        Copyright © 2024 GoBooking.com™. All rights reserved.
                    </p>
                    <div className="flex justify-center mt-4">
                        <div className="flex space-x-2"> {/* Giảm khoảng cách giữa các icon */}
